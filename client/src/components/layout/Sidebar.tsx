...
function SidebarNavItem({ icon, label, to, isActive, isCollapsed }: { icon: React.ReactNode, label: string, to: string, isActive: boolean, isCollapsed: boolean }) {
  return (
    <Link
      href={to}
      className={cn(
    ...
    >
      ...
      <div className="border-t border-border bg-card flex-shrink-0 p-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/profile" className="flex items-center space-x-3 flex-1 min-w-0 hover:bg-accent p-1 rounded-md transition-colors">
            <div className={cn(
