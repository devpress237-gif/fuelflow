...
- **Profile Management**: Replaced avatar URL field with a direct file upload feature (Base64). Added missing profile fields (email, phone, etc.) to the database and UI.
- **Filtering Enhancements**: Added date range filters to Supplier and Customer management pages for better reporting.
- **Pump Management**: Fixed pump status table to show actual product data and displayed the most recent closing reading value and date.
